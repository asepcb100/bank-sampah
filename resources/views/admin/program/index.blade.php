                        ...
                        <tr class="odd:bg-white even:bg-[#f6f1e2]/40 hover:bg-[#e9c688]/20 transition-colors">
                            ...
                            <td class="py-4 px-4 text-right sm:pr-6">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    <button type="button" onclick="openDeleteModal('{{ route('admin.program.destroy', $item->id) }}', '{{ addslashes($item->nama) }}')" class="px-3 py-1.5 rounded-full border border-rose-200 bg-rose-50 text-rose-700 hover:bg-rose-100 font-bold transition-all cursor-pointer">
                                        Hapus
                                    </button>
                                </div>
                            </td>
