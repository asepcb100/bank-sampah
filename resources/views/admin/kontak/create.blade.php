...
@section('title', 'Tambah Kontak PIC — Admin')

@section('page-heading', 'Tambah Kontak PIC')
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between border-b border-[#2b2417]/10 pb-4">
        <p class="text-xs text-[#6b6150]">Isi rincian nama PIC, nomor WhatsApp, peran/jabatan, dan status ketersediaan kontak.</p>
                ...
                <div class="bg-[#fbf8ef] rounded-3xl border border-[#2b2417]/16 p-6 sm:p-8 shadow-sm space-y-5">
                    ...
                    <div class="grid gap-1.5">
                        ...
                        <textarea name="address" 
                                  ...
                                  class="w-full px-4 py-3 bg-white border border-[#2b2417]/16 rounded-2xl text-xs sm:text-sm font-semibold text-[#2c3821] focus:outline-none focus:ring-2 focus:ring-[#c1852c] focus:border-[#c1852c] transition-all shadow-2xs">{{ old('address') }}</textarea>
                    </div>
