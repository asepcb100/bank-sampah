...
const photosList = ref<PhotoMedia[]>([
    ...
    {
        id: 3,
        url: 'https://images.unsplash.com/photo-1607006482602-765180037159?q=80&w=800&auto=format&fit=crop',
        is_primary: false,
        label: 'BARU'
    }
]);
...
const form = reactive({
    title: '',
    category_id: availableCategoriesList.value[0]?.id || 1,
    location: '',
...
// Trigger confirmation modal after validating local input
...
<template>
    <Head title="Tambah Kegiatan Galeri Baru — Admin BIL" />
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6 bg-[#f6f1e2]/30 rounded-2xl w-full">
        ...
        <div class="bg-[#2c3821] text-[#f6f1e2] rounded-2xl p-6 sm:p-8 shadow-sm border border-[#2b2417]/16">
            ...
            <h1 class="font-fraunces font-bold text-2xl sm:text-3xl text-white">Tambah Kegiatan Galeri Baru</h1>
            <p class="text-xs sm:text-sm text-[#f6f1e2]/85 mt-1">Lengkapi informasi dan dokumentasi foto untuk menambahkan kegiatan baru warga.</p>
        </div>
            ...
            <form @submit.prevent="openConfirmModal" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        required
                        placeholder="Contoh: Program Penimbangan Sedekah Sampah Pekan Ke-3"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            type="text"
                            required
                            placeholder="Contoh: Balai Desa Karangampel, Indramayu"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        placeholder="Tuliskan gambaran ringkas jalannya kegiatan warga..."
            ...
            <div class="relative bg-[#fbf8ef] rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-[#2b2417]/16">
                ...
                <div class="flex items-center justify-between border-b border-[#2b2417]/10 pb-3 mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <h3 class="font-fraunces font-bold text-lg text-[#2c3821]">Konfirmasi Isian Kegiatan</h3>
                ...
                <div class="flex items-center justify-end gap-3 pt-3 border-t border-[#2b2417]/10">
                    ...
                    >
                        ...
                        <span>{{ isSubmitting ? 'Menyimpan...' : 'Ya, Simpan Sekarang' }}</span>
                    </button>
                </div>
