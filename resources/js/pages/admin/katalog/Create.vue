...
const form = reactive({
    ...
    contact_id: availableContacts.value[0]?.id || 1,
...
function handleSubmit() {
    ...
    router.post('/admin/katalog', formData, {
        forceFormData: true
    });
}
</script>
...
<template>
    <Head title="Tambah Produk Katalog Baru — Admin BIL" />
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-4 sm:p-6 bg-[#f6f1e2]/30 rounded-2xl w-full">
        ...
        <div class="bg-[#2c3821] text-[#f6f1e2] rounded-2xl p-6 sm:p-8 shadow-sm border border-[#2b2417]/16">
            ...
            <h1 class="font-fraunces font-bold text-2xl sm:text-3xl text-white">Tambah Produk Katalog Baru</h1>
            <p class="text-xs sm:text-sm text-[#f6f1e2]/85 mt-1">Lengkapi detail produk olahan sirkular dan hubungkan dengan PIC WA pemesanan.</p>
        </div>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        required
                        placeholder="Contoh: Sabun Minyak Jelantah Alami"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                type="text"
                                required
                                placeholder="Contoh: Rp 10.000 / pcs"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows="4"
                        placeholder="Deskripsikan keunggulan dan manfaat produk olahan sirkular ini..."
